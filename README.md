...
SUPER_ADMIN_PASSWORD=choose-a-private-super-admin-password
...
Logging in with `SUPER_ADMIN_PASSWORD` also allows resident signup records to be removed
from property signup lists.
